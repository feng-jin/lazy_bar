...
- 左键点击菜单栏会从状态栏图标下方展开系统菜单样式的极简股票列表，仅展示名称、股价和涨跌幅；列表内容取打开瞬间的稳定快照；右键点击会从状态栏图标下方展开“设置 Settings”和“退出 Quit Lazy Bar”系统菜单；bar 顶部会按顺序轮播所有股票的紧凑摘要。
...
## 下一步重点
- 接入真实 A 股行情 provider。
- 稳定轮播与刷新策略，并在接入真实行情后替换 mock 刷新链路。
