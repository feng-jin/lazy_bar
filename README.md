...
- 左键点击菜单栏会从状态栏图标下方展开系统菜单样式的极简股票列表，仅展示名称、股价和涨跌幅；列表内容取打开瞬间的稳定快照；右键点击会从状态栏图标下方展开“设置 Settings”和“退出 Quit Lazy Bar”系统菜单；bar 顶部使用固定宽度 ticker 上下循环播放股票摘要，避免因文本长短不一导致状态栏宽度跳变。
