...
- 要调整状态栏标题、ticker 动画或点击行为：优先查看 `Sources/App/StatusBarController.swift`、`Sources/Views/MenuBar/MenuBarLabelView.swift`、`Sources/Views/MenuBar/MenuBarPresentation.swift`、`Sources/Views/MenuBar/MenuBarPresentationStore.swift`、`Sources/Views/MenuBar/MenuBarStyle.swift`、`Sources/ViewModels/MenuBarViewModel.swift` 和 `Sources/Models/DisplayQuote.swift`。
- 要调整主面板内容或股票列表项：优先查看 `Sources/App/StatusBarController.swift`、`Sources/Views/MenuBar/QuotesPopoverView.swift`、`Sources/Views/MenuBar/MenuBarPresentation.swift`、`Sources/Views/MenuBar/MenuBarPresentationStore.swift`、`Sources/Views/MenuBar/MenuBarStyle.swift`、`Sources/Views/MenuBar/QuoteColumnLayout.swift`、`Sources/Views/MenuBar/QuoteColumnsRowView.swift`、`Sources/ViewModels/MenuBarViewModel.swift` 和 `Sources/Models/DisplayQuote.swift`。
